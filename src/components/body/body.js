...
const ShowVerticalMenu = function (props) {
  if (props.title === 'Mobile') {
    return null;
  }

  return <VerticalMenu title={props.title}></VerticalMenu>;
};
    ...
    return (
      <div className="body-container">
        <div className="app-container">
          <ShowVerticalMenu title={this.props.title}></ShowVerticalMenu>
